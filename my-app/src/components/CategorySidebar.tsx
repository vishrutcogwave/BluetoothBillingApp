...
//   );
// }
import { Power, ShoppingBag, ChevronDown } from "lucide-react";
import { FALLBACK_IMAGE, type Category } from "../utils";
import { useAuth } from "../context/AuthContext";
    ...
    <>
      ...
      <aside className="fixed top-0 left-0 right-0 h-20 bg-[#0B1220] text-white md:hidden z-50 flex items-center px-2">
        ...
        <div className="relative">
          ...
          {/* Dropdown menu */}
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-32 bg-[#0B1220] border border-gray-600 rounded-lg shadow-lg z-50">
              <button
                onClick={logout}
                className="flex items-center gap-2 w-full px-3 py-2 hover:bg-red-600 text-white rounded-lg"
              >
